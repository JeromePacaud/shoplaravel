...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/jerome.pacaud@Digital-Grenoble.local/Modules/13-Laravel/shoplaravel/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/jerome.pacaud@Digital-Grenoble.local/Modules/13-Laravel/shoplaravel/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'debugbar.debug_backtrace_limit','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'generated::mrekZJPKeyPb8MGT','home','about','products.index','products.create',
'products.store','products.show','products.edit','products.update','products.destroy',
'admin.dashboard','admin.users','storage.local',);
        registerArgumentsSet('views', 
'about','admin.admin-productlist','components.alert','components.product-card','components.session-alert',
'index','layouts.app','partials.form','partials.product-card','partials.product-detail',
'products.create','products.edit','products.index','products.product_detail','welcome',
